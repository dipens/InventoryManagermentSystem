...
+----+----------+--------------------+---------------+-----------------+---------+------+--------------------------------------------------------------+---------------------+--------+---------+------------+---------------------------------------------+-----------------------+--------+---------------------+-----------------------+-------------+-------------+
|  1 | bobby    | bobby              | bobby@foo.com | bobby@foo.com   |        | NULL | $2y$13$I9SwBX8mT1frkKZqlsTJ3.7y9kQwu8aWPAhfW1wMETZLujqcTuwpi | 2018-07-03 08:14:59 | NULL   | NULL    | NULL       | MX6F5QllaI0HWEcUNxkUJheseEAV8xFxZestFKWq35M | NULL                  | a:0:{} | NULL                | NULL                  | NULL        | NULL        |
+----+----------+--------------------+---------------+-----------------+---------+------+--------------------------------------------------------------+---------------------+--------+---------+------------+---------------------------------------------+-----------------------+--------+---------------------+-----------------------+-------------+-------------+
