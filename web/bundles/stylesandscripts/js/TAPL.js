    ...
    $('#menu').on('click', 'a.menuLink', function(event) {
        ...
        switch (id)
        {
            ...
            case '9':
                ...
                break;
            case '215':
                window.open(Routing.generate('sales_order_my_dept_sales_order_lookup_homepage'));
                break;
            case '231':
                window.open(Routing.generate('picking_picking_summary_my_order_homepage'));
                break;
            case '232':
                window.open(Routing.generate('picking_picking_summary_my_team_homepage'));
                break;
            case '233':
                window.open(Routing.generate('picking_picking_summary_all_homepage'));
                break;
            case '234':
                window.open(Routing.generate('picking_picking_summary_my_dept_homepage'));
                break;
            case '236':
                window.open(Routing.generate('inventory_ttsswa_outstanding_homepage'));
                break;
            case '237':
                window.open(Routing.generate('inventory_ttsswa_homepage'));
                break;
            case '238':
                window.open(Routing.generate('inventory_swa_all_homepage'));
                break;
            case '239':
                window.open(Routing.generate('inventory_unshipped_swa_all_homepage'));
                break;
            case '240':
                window.open(Routing.generate('product_order_tts_read_only_lookup_homepage'));
                break;
            case '248':
                //contact
                window.open(Routing.generate('contacts_contacts_details_new_contact_homepage', {'ConClassification': '5', 'ConType': '1'}),"_blank");
                break;
            case '249':
                //vendor
                window.open(Routing.generate('contacts_contacts_details_new_contact_homepage', {'ConClassification': '8', 'ConType': '2'}),"_blank");
                break;
            case '250':
                //employee
                window.open(Routing.generate('contacts_contacts_details_new_contact_homepage', {'ConClassification': '6', 'ConType': '1'}),"_blank");
                break;
            case '251':
                //customer
                window.open(Routing.generate('contacts_contacts_details_new_contact_homepage', {'ConClassification': '7', 'ConType': '2'}),"_blank");
                break;
        }
    })
});